...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'    => 'Salles',
            'icon'    => 'fas fa-fw fa-share fa-arrow-alt-circle-right',
            'submenu' => [
                [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => ' Nombre de Machines par Salle',
                    'url'  => 'admin/charts',
                    
                ],
                [
                    'text'    => 'Liste des Machines par Salle',
                    'url'  => 'admin/lists',
